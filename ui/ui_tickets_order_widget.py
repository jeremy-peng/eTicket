...
class Ui_TicketOrderWidget(object):
    def setupUi(self, TicketOrderWidget):
        ...
        self.tableOrderDetailView = QtWidgets.QTableView(self.groupBox_3)
        self.tableOrderDetailView.setObjectName("tableOrderDetailView")
        self.horizontalLayout_2.addWidget(self.tableOrderDetailView)
